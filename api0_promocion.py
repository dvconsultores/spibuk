   ...
   #conecta con la table de control de ingreso de empleados
    ...
    try:
        ...
        for row in results:
            ...
            ##############################################################################################
            # aca revisamos si el proceso se esta ejecutando a destiempo y el colaborador ya no tiene relacion laboral activa
            ...
            cursor.execute(sql_query)
            results_retacionlaboralactiva = cursor.fetchone()[0]
            # Verificar si el COLABORADOR EXISTE
            if count_result == 0 or results_retacionlaboralactiva==0:
                # L   O   G   ****************************************************************
                ...
                "VALUES(%s, %s, %s, %s, %s, %s)"
                cursorApiEmpleado.execute(consulta, (transacction_id, fecha_actual,0,Buk_FICHA_JSON,Actividad,Estatus))
                #####*********************************************
            else:
