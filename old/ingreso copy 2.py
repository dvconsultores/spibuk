...
try:
   ...
   #conecta con la table de control de ingreso de empleados
    ...
    try:
        ...
        sql_query = "SELECT * FROM empleados where employee_id ='3654' and event_type  ='employee_create' and status_process is null"
        ...
        for row in results:
            ...
            Buk_ID_CARGO_NOMBRE=(dataEmpleado.get("data", []).get("current_job", {}).get("role", {}).get("custom_attributes", {}).get("cargo_abreviado"))[:35].upper()
...
#SELECT ID, NOMBRE1, NOMBRE2, APELLIDO1, APELLIDO2, ID_TIPO_IDEN, NACIONAL, NUM_IDEN, PASAPORTE, FECHA_NA, CIUDAD_NA, ID_ENTFE_NA, ID_PAIS_NA, SEXO, EDO_CIVIL, ZURDO, TIPO_SANGRE, FACTOR_RH, 
#DIRECCION, CIUDAD, ID_ENTFE, ID_PAIS, PARROQUIA, MUNICIPIO, COD_POSTAL, TELEFONO1, TELEFONO2, FAX, CELULAR, E_MAIL1, E_MAIL2, IN_REL_TRAB, 

#USRCRE, FECCRE, USRACT, FECACT,

#Vacios:
#NOMBRE_FOTO, ENFERMEDADOCU, ETNIAINDIGENA, DISCAUDITIVA, DISCVISUAL, DISCINTELECTUAL, DISCMENTAL, DISCMUSCULOESQ, DISCACCIDENTE, DISCOTRA, DESCRIDISCA

#FROM INFOCENT.EO_PERSONA;
